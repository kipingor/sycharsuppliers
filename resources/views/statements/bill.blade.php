    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            /* DomPDF-safe font with full UTF-8 support */
            font-size: 9pt;
            color: #1a1a2e;
            background: #fff;
            line-height: 1.4;
...
<body>
    <div class="page">
            ...
            <table class="header-table">
                <tr>
                    ...
                    <td style="width:60%; vertical-align:top;">
                        @if($company['logo'])
                        <img src="{{ $company['logo'] }}" style="max-height:18pt; max-width:60pt; margin-bottom:5pt;" alt="Logo">
                        <br>
                        @endif
                ...
                <tr>
                    ...
                    <td class="info-box">
                        ...
                        <div class="info-row mt-4" style="border-top:1px solid #dde4f5; padding-top:5pt;">
                            ...
                            <span class="info-value" style="color:{{ ($account_summary['balance'] ?? 0) > 0 ? '#e02424' : '#37847a' }}">
                ...
                <tr>
                    ...
                    <td>
                        <table class="amounts-table">
                            ...
                            @if($amounts['credited'])
                            <tr class="credit-row">
                                <td class="label-col">Credit Notes</td>
                                <td>({{ $amounts['credited'] }})</td>
                            </tr>
                            @endif
                            ...
                            <tr class="balance-row">
                                ...
                                <td style="color:{{ (float) str_replace(',', '', $amounts['balance']) > 0 ? '#e02424' : '#37847a' }};">
                                    {{ $amounts['balance'] }}
                                </td>
                            </tr>
                        </table>
        ...
        <div class="section-heading mt-8">Credit Notes Applied</div>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    <td class="mono font-bold">{{ $cn['reference'] }}</td>
                    <td>{{ $cn['type'] }}</td>
                    <td>{{ $cn['previous_account'] ?? '—' }}</td>
                    <td>{{ $cn['reason'] }}</td>
                    <td>{{ $cn['date'] }}</td>
                    <td class="text-right mono" style="color:#92400e;">({{ $cn['amount'] }})</td>
                </tr>
                @endforeach
            </tbody>
        </table>
