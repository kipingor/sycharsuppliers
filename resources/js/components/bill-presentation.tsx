/**
 * BillPresentation - Reusable bill display component
 * Used by both modal and standalone bill views
 */

import React from 'react';
import { formatCurrency } from '@/lib/utils';

interface BillPresentationProps {
  residentName: string;
...
const BillPresentation: React.FC<BillPresentationProps> = ({
  residentName,
  residentEmail,
  billNumber,
  billingDate,
  ...
  paid,
  due,
  companyName = 'Sychar Suppliers',
  companyPhone = '(+254)0714594646',
  companyEmail = 'sales@sycharsuppliers.com',
}) => {
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white border border-gray-200 rounded-lg shadow-md">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-gray-500">{companyPhone} | {companyEmail}</p>
      </div>
      ...
      <div className="mt-8 text-xs text-gray-600">
        <p>All cheques payable to {companyName}.</p>
